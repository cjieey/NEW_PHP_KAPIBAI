...
<script>
    ...
    function openEditPopup(id, name, price, quantity, image) {
...
if(isset($_POST['editProductId']) && isset($_POST['editProductName']) && isset($_POST['editProductPrice']) && isset($_POST['editProductQuantity'])) {
    ...
    $updateSql = "UPDATE products SET product_name='$editProductName', price=$editProductPrice, quantity=$editProductQuantity, image='$editProductImage' WHERE id='$editProductId'";
        ...
        if($connection) {
            ...
            if(mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<button onclick=\"openEditPopup('".$row['id']."','".$row['product_name']."','".$row['price']."','".$row['quantity']."','".$row['image']."')\">Edit</button>";
